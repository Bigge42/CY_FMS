...
import { loadVisualData } from '@/utils/loadVisualData.js'; // 替换为实际路径
...
import MyEquipmentStatus from '@/views/visualboard/components/MyEquipmentStatusChartT.vue';
import MyScheduleTable from '@/views/visualboard/components/MyScheduleTableT.vue';
...
export default {
  ...
  methods: {
    async fetchData() {
      try {
        const data = await loadVisualData(this.type); // 调用 loadVisualData 获取数据
